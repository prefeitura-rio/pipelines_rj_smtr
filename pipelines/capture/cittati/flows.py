...
CAPTURA_REGISTROS_CITTATI.state_handlers.append(handler_notify_failure(webhook="alertas_gps"))
...
CAPTURA_REALOCACAO_CITTATI.state_handlers.append(handler_notify_failure(webhook="alertas_gps"))
