...
def create_gps_extractor(
    ...
    return partial(
        ...
        source=source,
        timestamp=timestamp,
        base_url=constants.CITTATI_BASE_URL.value,
        registros_endpoint=constants.CITTATI_REGISTROS_ENDPOINT.value,
        realocacao_endpoint=constants.CITTATI_REALOCACAO_ENDPOINT.value,
        secret_path=constants.CITTATI_SECRET_PATH.value,
        registros_table_id=constants.CITTATI_REGISTROS_TABLE_ID.value,
    )
