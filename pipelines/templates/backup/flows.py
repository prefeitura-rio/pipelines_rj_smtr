...
default_capture_flow.state_handlers = [handler_initialize_sentry, handler_inject_bd_credentials]
...
default_materialization_flow.state_handlers = [handler_initialize_sentry, handler_inject_bd_credentials]
