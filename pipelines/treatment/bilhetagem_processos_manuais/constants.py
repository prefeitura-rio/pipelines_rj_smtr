...
class constants(Enum):  # pylint: disable=c0103
    ...
    CAPTURE_GAP_TABLES = {
        jae_constants.TRANSACAO_TABLE_ID.value: CAPTURA_TRANSACAO.name,
        jae_constants.TRANSACAO_RIOCARD_TABLE_ID.value: CAPTURA_TRANSACAO_RIOCARD.name,
        jae_constants.GPS_VALIDADOR_TABLE_ID.value: CAPTURA_GPS_VALIDADOR.name,
        jae_constants.LANCAMENTO_TABLE_ID.value: CAPTURA_LANCAMENTO.name,
        CLIENTE_TABLE_ID: CAPTURA_AUXILIAR.name,
    }
