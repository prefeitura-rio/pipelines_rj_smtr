...
from pipelines.tasks import get_rounded_timestamp, get_current_timestamp

from pipelines.constants import constants

from pipelines.schedules import every_hour, every_minute, every_day_hour_five
...
bilhetagem_transacao_captura.state_handlers = [handler_inject_bd_credentials]
...
bilhetagem_tracking_captura.state_handlers = [handler_inject_bd_credentials]
...
bilhetagem_ressarcimento_captura.state_handlers = [handler_inject_bd_credentials]
...
bilhetagem_auxiliar_captura.state_handlers = [handler_inject_bd_credentials]
...
bilhetagem_materializacao_transacao.state_handlers = [handler_inject_bd_credentials]
...
bilhetagem_materializacao_ordem_pagamento.state_handlers = [handler_inject_bd_credentials]
...
bilhetagem_recaptura.state_handlers = [handler_inject_bd_credentials]
...
bilhetagem_transacao_tratamento.state_handlers = [handler_inject_bd_credentials]
...
bilhetagem_gps_tratamento.state_handlers=[handler_inject_bd_credentials]
