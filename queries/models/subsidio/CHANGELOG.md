...
- Criada exceção para os tipo_viagem `Validador associado incorretamente` no dia `2025-10-10` no modelo `viagem_transacao_aux_v2` (https://github.com/prefeitura-rio/pipelines_rj_smtr/pull/995)
