...
{% set condicao_veiculo %}
    ...
    and not vt.indicador_temperatura_nula_viagem and (vt.data not between('{{ var("DATA_SUBSIDIO_V22_INICIO") }}') and date("2025-11-15")) --Período de interrupção dos descontos por inoperabilidade do ar-condicionado
{% endset %}
