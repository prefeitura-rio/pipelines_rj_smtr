...
SELECT
  ...
  SAFE_CAST(JSON_VALUE(content,'$.auinf_local_ende_bairro') AS STRING) AS bairro_autuacao,
  SAFE_CAST(JSON_VALUE(content,'$.auinf_local_ende_cep') AS STRING) AS cep_autuacao,
  SAFE_CAST(JSON_VALUE(content,'$.auinf_local_ende_logradouro') AS STRING) AS logradouro_autuacao,
  ...
  SAFE_CAST(JSON_VALUE(content,'$.rrso_num_processo') AS STRING) AS rrso_num_processo,
  SAFE_CAST(JSON_VALUE(content,'$.cpa_num_processo') AS STRING) AS cpa_num_processo,
  SAFE_CAST(JSON_VALUE(content,'$.susp_num_processo') AS STRING) AS susp_num_processo,
