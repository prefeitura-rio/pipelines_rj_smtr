...
- Corrigido o modelo `viagem_planejada.sql` para não não utilizar o modelo `viagem_planejada_v1.sql` antes de `2024-04-01` (https://github.com/prefeitura-rio/pipelines_rj_smtr/pull/)
