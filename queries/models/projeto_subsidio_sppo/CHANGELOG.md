...
- Adicionada coluna `feed_start_date` no modelo `viagem_planejada.sql` para o período anterior a `2024-04-01` (https://github.com/prefeitura-rio/pipelines_rj_smtr/pull/656) (https://github.com/prefeitura-rio/pipelines_rj_smtr/pull/656)
