...
- Corrigida a alteração para tipo de dia `ENEM` e `V+ENEM` no modelo `ordem_servico_trips_shapes_gtfs_v2.sql` (https://github.com/prefeitura-rio/pipelines_rj_smtr/pull/1070)
