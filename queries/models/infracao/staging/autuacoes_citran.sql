...
SELECT
  ...
  Cod__Detran as id_auto_infracao, -- coluna oculta
  ...
  SAFE_CAST(JSON_VALUE(content,'$.Cep') AS STRING) cep_proprietario, -- coluna oculta
  ...
  SAFE_CAST(JSON_VALUE(content,'$.LocInf') AS STRING) local_autuacao, -- coluna oculta
