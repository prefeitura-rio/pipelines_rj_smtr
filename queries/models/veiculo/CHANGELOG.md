...
### Alterado
- Alterado o modelo `sppo_veiculo_dia.sql` para remover os status `Autuado por segurança` e `Autuado por limpeza/equipamento` a partir e 2025-04-01 (https://github.com/prefeitura-rio/pipelines_rj_smtr/pull/)
