...
- Adiciona obrigatoriedade no filtro de partição no modelo da tabela `extrato_cliente_cartao.sql` (https://github.com/prefeitura-rio/pipelines_rj_smtr/pull/1186)
