...
-- 1. Viagens planejadas
  ...
  SELECT
    ...
    consorcio,
    servico,
    faixa_horaria_inicio, --SAFE_CAST('{{ var("start_date") }}T00:00:00' AS DATETIME) AS faixa_horaria_inicio,
    faixa_horaria_fim, -- SAFE_CAST('{{ var("start_date") }}T23:59:59' AS DATETIME) AS faixa_horaria_fim,
