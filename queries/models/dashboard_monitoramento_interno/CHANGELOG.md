...
- Altera o modelo `view_viagem_climatizacao.sql` para consultar os dados de `id_validador`e `operadora` da view `validador_operadora` (https://github.com/prefeitura-rio/pipelines_rj_smtr/pull/1157)
