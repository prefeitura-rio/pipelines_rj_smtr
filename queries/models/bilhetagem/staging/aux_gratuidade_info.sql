...
with
    gratuidade as (
        select
            * except (datatetime_inicio_validade, datetime_fim_validade),
            datatetime_inicio_validade as datatetime_inicio_validade_gratuidade,
    ...
    gratuidade_estudante as (
        select
            ...
            case
                when
                    g.datatetime_inicio_validade_gratuidade
                    > e.datetime_inicio_validade_estudante
                then g.datatetime_inicio_validade_gratuidade
                else e.datetime_inicio_validade_estudante
            end as datatetime_inicio_validade_gratuidade
        from gratuidade g
    ...
    gratuidade_estudante_fim_validade as (
        select
            *,
            lead(datatetime_inicio_validade_gratuidade) over (
                partition by id_cliente order by datatetime_inicio_validade_gratuidade
            ) as datetime_fim_validade_gratuidade
        from gratuidade_estudante
        qualify
            datatetime_inicio_validade_gratuidade != datetime_fim_validade_gratuidade
    ...
    outras_gratuidades as (
        select
            ...
            tipo_gratuidade,
            datatetime_inicio_validade_gratuidade,
    ...
    union_gratuidade as (
        select
            ...
            datatetime_inicio_validade_gratuidade as datatetime_inicio_validade,
