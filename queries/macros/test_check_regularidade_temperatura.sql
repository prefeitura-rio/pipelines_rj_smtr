        ...
        teste_1_falha as (
            ...
            where
                (
                    ...
                    and (data < date("{{ var('DATA_SUBSIDIO_V20_INICIO') }}") or ( data >= date("{{ var('DATA_SUBSIDIO_V20_INICIO') }}")
        ...
        teste_2_falha as (
            ...
            where
                (
                    ...
                    and (
                        (data < date("{{ var('DATA_SUBSIDIO_V20_INICIO') }}") or ( data >= date("{{ var('DATA_SUBSIDIO_V20_INICIO') }}")
