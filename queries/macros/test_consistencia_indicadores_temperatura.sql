with
    indicadores as (
        select
            ...
            safe_cast(
                json_value(indicadores, '$.indicador_validador.id_validador') as string
            ) as validador,
            safe_cast(
                json_value(
            ...
            *,
            case
                when
                    ...
                    and i.indicador_temperatura_pos_tratamento_descartada_viagem = true
                then
...
left join
    indicador_temperatura_pos_tratamento_descartada_viagem dd using (data, id_viagem)
left join indicador_temperatura_zero_descartada iz using (data, id_viagem)
