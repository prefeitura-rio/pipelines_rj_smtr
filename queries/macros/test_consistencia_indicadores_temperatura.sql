{% test consistencia_indicadores_temperatura(model) -%}
    with
        ...
        indicador_temperatura_zero_descartada as (
            ...
            from indicadores i
            left join
                percentuais p using (data, id_viagem, id_validador)),
                        ...
                        case
                            when
                                (
                                    ...
                                    and p.test_percentual_temperatura_nula_descartada
                                    = 100
            ...
            left join
                indicador_temperatura_variacao_viagem vv using (
                    data, id_viagem, id_validador
                )
            left join
            ...
            left join
                indicador_temperatura_zero_descartada iz using (
                    data, id_viagem, id_validador
                )
